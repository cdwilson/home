...
# export PS1_SUFFIX="${PROMPT_BLUE}history${PROMPT_RESET}: \!\n${PROMPT_MAGENTA}\$${PROMPT_RESET} "
export PS1_SUFFIX="${PROMPT_BLUE}(${PROMPT_RESET}\!${PROMPT_BLUE})${PROMPT_RESET}${PROMPT_MAGENTA}\$${PROMPT_RESET} "
